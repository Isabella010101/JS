...
function showSlide(index) {
  slides.forEach((slide, i)=>{
   //Adicionar a classe "Active" ao slide atual e remove dos demais
...
function prevSlide () {
  currentSlide = (currentSlide - 1 + slides.length) % slides.length; //Se o currentSlide = 0 (0-1 resultaria em negativo -1)
  showSlide(currentSlide);
}
